#!/usr/bin/env python3
"""Run 2dehands scraper with health tracking and partial data preservation."""
...
PLATFORM = "2dehands"
OUTFILE = "/tmp/domus-batches/2dehands.json"

try:
    if is_scraper_skipped(PLATFORM):
        print(f"2DEHANDS SKIPPED: rate limit protection active (24h skip)")
    ...
    print(f"2DEHANDS OK: {len(out)} listings ({elapsed:.1f}s)")
